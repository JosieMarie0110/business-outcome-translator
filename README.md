...
- Customer challenge  
- Product capability  
- Audience (e.g., Executive, Technical)  

Output:
- Clear, structured value messaging  
...
**Input:**  
Improve visibility into unmanaged devices  

**Output:**  
- Outcome: Continuous asset visibility  
- Value: Reduced risk from unknown assets  
