...
APP_SUBTITLE = "Translate product capabilities into business outcomes and customer value narratives."
        ...
        with gr.Column(scale=6):
            ...
            with gr.Group(elem_classes=["panel"]):
                ...
                customer_goal = gr.Textbox(
                    label="Customer Goal",
                    lines=4,
                    placeholder="Example: Improve network security visibility."
                )

                customer_challenge = gr.Textbox(
                    label="Customer Challenge",
                    lines=6,
                    placeholder="Example: Limited visibility into unmanaged devices connecting to the network."
                )
